<template>
    <div>
        ...
        <button @click="abrirModal = true"
                ...
                style="bottom:24px;right:24px;width:56px;height:56px;background-color:#0dc9ee;border:none;z-index:9999;">
        ...
        <transition name="slide-delay">
            <div v-if="abrirModal" class="position-fixed" style="bottom:90px;right:24px;z-index:10000;">
                <div class="bg-white rounded-4 shadow d-flex flex-column"
                     style="width:90vw;max-width:400px;height:70vh;max-height:500px;overflow:hidden;">
                    <div class="d-flex align-items-center justify-content-between px-3 py-2"
                         style="background-color: #0dc9ee;">
                        <div class="d-flex align-items-center gap-2 text-white">
                            <img src="/imagens/ia-perfil.png" alt="IA" width="30" class="rounded-circle"/>
                            <strong>Suporte IA - FlowTask</strong>
                        </div>
                        <button class="btn btn-sm btn-close-white" style="background:transparent;border:none;"
