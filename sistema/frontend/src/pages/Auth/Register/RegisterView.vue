<template>
    <div class="container d-flex justify-content-center align-items-center vh-100" style="background-color:#111827;margin-top:30px;">
        <div class="p-4 w-100" style="max-width:420px;border-radius:12px;background-color:#111827;border:2px solid #0dc9ee;position:relative;">
            <div style="position:absolute;top:-2px;left:-2px;right:-2px;bottom:-2px;z-index:-1;border-radius:12px;background:linear-gradient(90deg,#0dc9ee,#0d6dfb);"></div>
            ...
            <form @submit.prevent="register">
                <div class="mb-3 position-relative">
                    ...
                    <input v-model="name" @blur="nameTocado = true" type="text" id="name" required class="form-control pe-5"
                ...
                <div class="mb-3 position-relative">
                    ...
                    <input v-model="email" @blur="emailTocado = true" type="email" id="email" required class="form-control pe-5"
                ...
                <div class="mb-3 position-relative">
                    ...
                    <input :type="showPassword ? 'text' : 'password'" id="password" v-model="password" @blur="senhaTocada = true" class="form-control pe-5"
                    ...
                    <span class="position-absolute" style="top: 38px; right: 40px; cursor: pointer;" @click="togglePassword">
                ...
                <div class="mb-4 position-relative">
                    ...
                    <input :type="showPasswordConfirm ? 'text' : 'password'" id="password_confirmation" v-model="password_confirmation" @blur="confirmacaoTocada = true" class="form-control pe-5"
                    ...
                    <span class="position-absolute" style="top: 38px; right: 40px; cursor: pointer;" @click="togglePasswordConfirm">
                    ...
                    <div v-else-if="confirmacaoTocada && validaConfirmacaoSenha" class="text-danger small mt-1">{{ validaConfirmacaoSenha }}</div>
                </div>

                <div class="d-flex justify-content-between">
                    <router-link to="/login" class="btn btn-outline-light" style="border-color:#0dc9ee;color:#0dc9ee;transition:all 0.3s ease;"
