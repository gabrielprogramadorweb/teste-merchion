<template>
    <div class="container d-flex justify-content-center align-items-center mt-5">
        <div class="card p-4 rounded-4 shadow-lg bg-transparent border border-primary text-white"
             style="max-width:600px;width:100%;margin-top:100px;">
            <h3 class="mb-4 text-center fw-bold text-info">Editar Perfil</h3>

            <form @submit.prevent="submitForm">
                <div class="text-center mb-4">
                    <div class="mx-auto mb-2 border border-3 border-info rounded-circle overflow-hidden"
                    ...
                    <div v-if="showModal"
                        ...
                        <div class="bg-white text-dark p-4 rounded-3" style="max-width: 500px; width: 100%;">
                            ...
                            <div class="mt-3 text-end">
                                <button type="button" class="btn btn-secondary me-2" @click="closeModal">Cancelar
                                </button>
                ...
                <div class="form-floating mb-4 text-gray-400">
                    <input v-model="name" type="text"
                           class="form-control bg-transparent border border-primary text-white" id="floatingName"
